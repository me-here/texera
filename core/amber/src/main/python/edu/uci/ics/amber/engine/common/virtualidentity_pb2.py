...
ActorVirtualIdentity = _reflection.GeneratedProtocolMessageType('ActorVirtualIdentity', (_message.Message,), {
  ...
  '__module__' : 'edu.uci.ics.amber.engine.common.virtualidentity_pb2'
