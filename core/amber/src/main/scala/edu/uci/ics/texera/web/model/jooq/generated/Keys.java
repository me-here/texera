...
public class Keys {
    ...
    public static final UniqueKey<UserDictionaryRecord> KEY_USER_DICTIONARY_PRIMARY = Internal.createUniqueKey(UserDictionary.USER_DICTIONARY, DSL.name("KEY_user_dictionary_PRIMARY"), new TableField[] { UserDictionary.USER_DICTIONARY.UID, UserDictionary.USER_DICTIONARY.KEY }, true);
    ...
    public static final ForeignKey<UserDictionaryRecord, UserRecord> USER_DICTIONARY_IBFK_1 = Internal.createForeignKey(UserDictionary.USER_DICTIONARY, DSL.name("user_dictionary_ibfk_1"), new TableField[] { UserDictionary.USER_DICTIONARY.UID }, Keys.KEY_USER_PRIMARY, new TableField[] { User.USER.UID }, true);
