...
final case class OperatorIdentity(
    ...
    with scalapb.lenses.Updatable[OperatorIdentity] {
  @transient
...
object OperatorIdentity
  ...
  implicit class OperatorIdentityLens[UpperPB](
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    VirtualidentityProto.javaDescriptor.getMessageTypes().get(7)

  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    VirtualidentityProto.scalaDescriptor.messages(7)
  ...
  def of(
      workflow: _root_.scala.Predef.String,
      operator: _root_.scala.Predef.String
  ): _root_.edu.uci.ics.amber.engine.common.virtualidentity.OperatorIdentity =
    _root_.edu.uci.ics.amber.engine.common.virtualidentity.OperatorIdentity(
      workflow,
      operator
    )
