...
public class UserDictionaryDao extends DAOImpl<UserDictionaryRecord, edu.uci.ics.texera.web.model.jooq.generated.tables.pojos.UserDictionary, Record2<UInteger, String>> {
     ...
     */
    public List<edu.uci.ics.texera.web.model.jooq.generated.tables.pojos.UserDictionary> fetchRangeOfValue(JSON lowerInclusive, JSON upperInclusive) {
     ...
     */
    public List<edu.uci.ics.texera.web.model.jooq.generated.tables.pojos.UserDictionary> fetchByValue(JSON... values) {
