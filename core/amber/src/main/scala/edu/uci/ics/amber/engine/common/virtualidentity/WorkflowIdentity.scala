...
final case class WorkflowIdentity(
    ...
    with scalapb.lenses.Updatable[WorkflowIdentity] {
  @transient
...
object WorkflowIdentity
  ...
  implicit class WorkflowIdentityLens[UpperPB](
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    VirtualidentityProto.javaDescriptor.getMessageTypes().get(8)

  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    VirtualidentityProto.scalaDescriptor.messages(8)
  ...
  def of(
      id: _root_.scala.Predef.String
  ): _root_.edu.uci.ics.amber.engine.common.virtualidentity.WorkflowIdentity =
    _root_.edu.uci.ics.amber.engine.common.virtualidentity.WorkflowIdentity(
      id
    )
