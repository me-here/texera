...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record5<String, UInteger, String, String, String>, IUser {
    ...
    private static final long serialVersionUID = -1380543325;
    ...
    /**
     * Setter for <code>texera_db.user.avatar</code>.
     */
    @Override
    ...
    /**
     * Getter for <code>texera_db.user.avatar</code>.
     */
    @Override
     ...
     */
    public UserRecord(String name, UInteger uid, String password, String googleId, String avatar) {
        super(User.USER);
