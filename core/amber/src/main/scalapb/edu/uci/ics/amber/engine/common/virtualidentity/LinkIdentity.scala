...
object LinkIdentity extends scalapb.GeneratedMessageCompanion[edu.uci.ics.amber.engine.common.virtualidentity.LinkIdentity] {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[edu.uci.ics.amber.engine.common.virtualidentity.LinkIdentity] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      edu.uci.ics.amber.engine.common.virtualidentity.LinkIdentity(
        from = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).get.as[edu.uci.ics.amber.engine.common.virtualidentity.LayerIdentity],
        to = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).get.as[edu.uci.ics.amber.engine.common.virtualidentity.LayerIdentity]
      )
