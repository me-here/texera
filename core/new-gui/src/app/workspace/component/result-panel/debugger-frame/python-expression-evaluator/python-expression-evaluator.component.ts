...
@Component({
  selector: "texera-python-expression-evaluator",
  templateUrl: "./python-expression-evaluator.component.html",
  styleUrls: ["./python-expression-evaluator.component.scss"],
})
export class PythonExpressionEvaluatorComponent implements OnInit {
